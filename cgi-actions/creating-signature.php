    ...
    <div class="container-fluid container-content" style="margin-top: 10%;">
        <div class="row-main row">
            <div class="col-7 clear-content" style="position: relative; margin-left: 21%; margin-top: 10% !important;">
                ...
                <a href="https://localhostcgi-actions/my_signatures.php" role="button" class="btn btn-lg bt-primary">See my signatures</a>
				<a href="https://localhostindex.php" role="button" class="btn btn-block btn-success">Get back to the home</a>
            </div>
        </div>
    </div>
    <br>
