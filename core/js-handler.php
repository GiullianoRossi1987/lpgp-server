...
function lsSignaturesMA(int $proprietary){
    ...
    foreach($signatures as $cd){
        ...
        $card .= "<a href=\"https://localhostcgi-actions/get_my_signature.php?id=$cd\">Download <i class=\"fas fa-file-download\"></i></a>" . "<br><br>".
                 "<a href=\"https://localhostcgi-actions/ch_signature_data.php?sig_id=$cd\">Configurations<i class=\"fas fa-cog\"></i></a>\n"
                . "</div>\n</div>\n</div><br>";
        $all .= "\n$card\n";
    }
    return $all;
