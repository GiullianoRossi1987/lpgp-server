...
<body>
    ...
    <div class="container-fluid container-content" style="position: relative;">
        <div class="row-main row">
            <div class="col-6 clear-content" style="position: relative; margin-left: 23%;">
                <br>
    ...
    <div class="footer-container container">
        <div class="footer-row row">
            <div class="footer col-12" style="height: 150px; background-color: black; margin-top: 90%; position: relative; max-width: 100%; left: 0;">
